      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-12">
        ...
        <article className="bg-white rounded-3xl shadow-sm border border-[#efe7db] p-8 md:p-12">
          ...
          <div className="space-y-6 text-gray-800 leading-relaxed">
            <p>WORLD NOW (“we”, “our”, “us”) operates this website and related services. This Privacy Policy explains how we collect, use, store, and share information when you read articles, subscribe to RSS, or contact the newsroom.</p>
            ...
            <section className="rounded-2xl border border-[#efe7db] bg-[#fffdfa] p-5">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                ...
                <li>Cookies and similar technologies to remember your preferences and improve site performance.</li>
              </ul>
            </section>
            ...
            <section className="rounded-2xl border border-[#efe7db] bg-[#fffdfa] p-5">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                ...
                <li>To understand site usage, improve article recommendations, and protect against abuse.</li>
              </ul>
            </section>

            <section className="rounded-2xl border border-[#efe7db] bg-[#fffdfa] p-5">
              <h2 className="text-xl font-semibold text-[#0d0d0d] mb-2">3. Cookies</h2>
              <p className="text-sm">We may use necessary cookies and optional analytics to understand traffic and improve the reading experience. You can usually manage or disable cookies in your browser settings.</p>
            </section>
            ...
            <section className="rounded-2xl border border-[#efe7db] bg-[#fffdfa] p-5">
              ...
              <p className="text-sm">Our website may contain links to external publishers or social platforms. We are not responsible for the privacy practices of those third-party services.</p>
            </section>
